...
AVAILABLE_MODELS = {
    ...
    "2": {
        "name": "千问3.6-Plus 旗舰（¥4.00/¥12.00/百万token）",
        "model": "qwen3.6-plus",
        "provider": "dashscope",
        "env_key": "DASHSCOPE_API_KEY",
        "free_tier": False,
    ...
    "8": {
        "name": "千问3.6-Flash（¥0.30/¥0.60/百万token）",
        "model": "qwen3.6-flash",
        "provider": "dashscope",
        "env_key": "DASHSCOPE_API_KEY",
        "free_tier": True,
