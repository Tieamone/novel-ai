...
#### 3. 核心逻辑层（write_chapter() 主函数，第867-1037行）
- **配置读取增强**:
  ```python
...
7. **为什么补写逻辑要增加上限保护？**
   ...
   - 达到 word_max 时停止补写，并给出明确的日志提示

8. **为什么选择 3000-4000 这个范围？**
